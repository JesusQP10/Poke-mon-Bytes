 ...
 * para el proceso de login. Actúa como intermediario entre el Controlador y el Repositorio.
 */
...
public class AuthService {
     ...
     * 1. UserRepository: Para poder guardar y buscar en la BD.
     * 2. PasswordEncoder: El bean BCrypt definido en SecurityConfig para hashear contraseñas.
     */
